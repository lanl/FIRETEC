...
!
! FIXME !everything in small timestep loop
!
!       do k=1,lfuel
       do k=1,l
!
...
c walltimer !KOO         
     ...
     +              np,mp,l,1-ih,np+ih,1-ih,mp+ih,1)
      enddo
      call updated(pr,pr,np,mp,l,1-ih,np+ih,1-ih,mp+ih,1)
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     + call heatSourceRHS(i,j,k,fi,frho,dtp)
        ! TODO : check why f1avg,.. are forced to 0 at the
        ! end of "force" and beginning of "turb":
        ! forcing of xvb(1,2,3) should be done here only!

...
c      allocate (rely(1-ih:mp+ih))
      allocate (f1(1-ih:np+ih,1-ih:mp+ih,l))
      allocate (f2(1-ih:np+ih,1-ih:mp+ih,l))
      allocate (f3(1-ih:np+ih,1-ih:mp+ih,l))
      ...
      allocate(actualfueldepth(1-ih:np+ih,1-ih:mp+ih,l))
      allocate(rhof(1-ih:np+ih,1-ih:mp+ih,l))
      allocate(sizescale(1-ih:np+ih,1-ih:mp+ih,l))   !FP :ss as array
      allocate(rhofinitial(1-ih:np+ih,1-ih:mp+ih,l))
      ...
      allocate (convht(1-ih:np+ih,1-ih:mp+ih,l));     convht=0. 
      allocate(frhosiesrad(1-ih:np+ih,1-ih:mp+ih,l)); frhosiesrad=0.
      
      allocate (temps(1-ih:np+ih,1-ih:mp+ih,l));     temps=0.
      allocate (tempg(1-ih:np+ih,1-ih:mp+ih,l));     tempg=0.
      allocate (tambientarray(1-ih:np+ih,1-ih:mp+ih,l))
      tambientarray=0.
      allocate (firad(1-ih:np+ih,1-ih:mp+ih,l));     firad=0.
      if (iradeastflux) then
      ...
      allocate (psiwmax(1-ih:np+ih,1-ih:mp+ih,l));   psiwmax=0.
      if(irhovapor.eq.1)
     .allocate(frhovaporb(1-ih:np+ih,1-ih:mp+ih,l)) 
      endif
      allocate (xv(1-ih:np+ih,1-ih:mp+ih,l,5))
      allocate (xvfuel(1-ih:np+ih,1-ih:mp+ih,l,5))
     ...
     +   allocate (uprofile(1-ih:np+ih,1-ih:mp+ih,l)) !FP
      ...
      if (inonlocal.eq.1) then
         ...
         allocate (psif(1-ih:np+ih,1-ih:mp+ih,l));      psif=0.
         allocate (psiw(1-ih:np+ih,1-ih:mp+ih,l));      psiw=0.
         allocate (frhowater(1-ih:np+ih,1-ih:mp+ih,l)); frhowater=0.
     ...
     .    allocate(frhovapor(1-ih:np+ih,1-ih:mp+ih,l)) 
         ...
         allocate(frhof(1-ih:np+ih,1-ih:mp+ih,l))
         allocate (frhosies(1-ih:np+ih,1-ih:mp+ih,l));  frhosies=0.
         allocate (cf(1-ih:np+ih,1-ih:mp+ih,l));         cf=0.
         allocate(thetasolid(1-ih:np+ih,1-ih:mp+ih,l)); thetasolid=0.
         allocate (fi(1-ih:np+ih,1-ih:mp+ih,l))
         allocate (ff(1-ih:np+ih,1-ih:mp+ih,l));        ff=0.
         allocate (fw(1-ih:np+ih,1-ih:mp+ih,l));        fw=0.

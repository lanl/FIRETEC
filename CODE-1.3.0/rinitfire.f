...
ccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     +          'dense shrub plot1 (spain, vega)'
            ...
            rmoist(i,j,k)=.61
            sizescale(i,j,k)=2.0/4000.0
            rhof(i,j,1)=1.7/(zcart(zedge(2),i,j)-
     +        zcart(zedge(1),i,j))  !1.7kg/m2
     ...
     +          'gorse edres 1  (spain, vega)'
            ...
            actualfueldepth(i,j,1)=1.25
            rmoist(i,j,k)=.7
            sizescale(i,j,k)=2.0/4000.0
            rhof(i,j,1)=2./(zcart(zedge(2),i,j)-
     +        zcart(zedge(1),i,j))  !2.0 kg/m2
     ...
     +          'australian grassland, cheney'
            ...
            actualfueldepth(i,j,1)=0.4
            rmoist(i,j,k)=.05
            sizescale(i,j,k)=2.0/12000.0
            rhof(i,j,1)=0.4/(zcart(zedge(2),i,j)-
     +        zcart(zedge(1),i,j))  !0.4kg/m2

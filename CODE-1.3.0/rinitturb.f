...
!        end if
      ...
      enddo
      do nn=5,6
       call updated(xe(1-ih,1-ih,1,nn),xe(1-ih,1-ih,1,nn),np,mp,l,1-ih,np+ih,1-ih,mp+ih,1,0)
      enddo
      call updated(saxy,saxy,np,mp,l,1-ih,np+ih,1-ih,mp+ih,1,0)
      call updated(saz,saz,np,mp,l,1-ih,np+ih,1-ih,mp+ih,1,0)
      call updated(sa,sa,np,mp,l,1-ih,np+ih,1-ih,mp+ih,1,0)
      call updated(sb,sb,np,mp,l,1-ih,np+ih,1-ih,mp+ih,1,0)
      !call updated(sc,sc,np,mp,l,1-ih,np+ih,1-ih,mp+ih,1)
      call updated(cd,cd,np,mp,l,1-ih,np+ih,1-ih,mp+ih,1,0)
